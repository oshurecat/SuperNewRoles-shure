...
namespace SuperNewRoles
{
    public static class PVCreator
    {
        ...
        public static void Start2()
        {
            UpdateTime = UpdateTimeD;
            Is2 = true;
            Logger.Info(posdatas.Count.ToString());
            if (players.Count < posdatas.Count || players.TrueForAll(x => x == null))
            {
                players = new();
            ...
            if (Is2)
            {
                ...
                if (UpdateTime <= 0)
                {
                    ...
                    for (int i = 0; i < posdatas.Count; i++)
                    {
                        ...
                        if (posdatas[playerindex][index[playerindex]].x == posdatas[playerindex][index[playerindex] - 1].x && posdatas[playerindex][index[playerindex]].y == posdatas[playerindex][index[playerindex] - 1].y)
                        {
                        ...
                        if (index[playerindex] > 0)
                        {
                            ...
                            players[playerindex].cosmetics.currentBodySprite.BodySprite.transform.FindChild("ColorblindName_TMP").localScale = posdatas[playerindex][index[playerindex]].x > posdatas[playerindex][index[playerindex] - 1].x ? new(2.8f, 2.8f, 1) : new(-2.8f, 2.8f, 1);
                            if (players[playerindex].cosmetics.currentBodySprite.BodySprite.transform.FindChild("Info") != null) players[playerindex].cosmetics.currentBodySprite.BodySprite.transform.FindChild("Info").localScale = posdatas[playerindex][index[playerindex]].x > posdatas[playerindex][index[playerindex] - 1].x ? new(2.8f, 2.8f, 1) : new(-2.8f, 2.8f, 1);
                        }
                    }
                }
            }
